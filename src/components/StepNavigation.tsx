...
const STEPS: Step[] = [
  ...
  { path: "/persona", icon: "🧠", label: "ペルソナ設計", phase: 2, phaseLabel: "フェーズ②", description: "JDからターゲットペルソナを3パターン自動設計" },
  { path: "/job-convert", icon: "🔄", label: "媒体別変換", phase: 2, phaseLabel: "フェーズ②", description: "マスター求人票をBizReach・Wantedly等に一括変換" },
  { path: "/scout", icon: "✉️", label: "スカウト生成", phase: 2, phaseLabel: "フェーズ②", description: "ペルソナ×媒体最適化スカウトテンプレート生成" },
